...
export const baseUrl = 'https://chat.pifans.app/';//新服务器
export const https = (url, data, method = 'GET') => {
	let token = uni.getStorageSync("token") || "";
	let lang = uni.getStorageSync("locale") || "zh-cn";
	// const baseUrl = 'http://81.68.107.157:9501/'
	const baseUrl = 'https://chat.pifans.app/'
	for (const k in data) {
