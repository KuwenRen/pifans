<template>
	<view class="u-navbar">
		<view class="u-navbar__placeholder" v-if="fixed && placeholder"></view>
		<!-- :style="{
		...
		<view :class="[fixed && 'u-navbar--fixed']">
			...
			<view class="u-navbar__content" :class="[border && 'u-border-bottom']" :style="{
				...
				<image v-if="showMore" style="position: absolute;right: 30rpx;;width: 48rpx;" src="../../../../static/img/more.png"
					mode="widthFix" @click="moreClick"></image>
			</view>
		</view>
	</view>
</template>
