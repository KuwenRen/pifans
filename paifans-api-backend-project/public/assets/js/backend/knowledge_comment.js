define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'knowledge_comment/index' + location.search,
                    add_url: 'knowledge_comment/add',
                    edit_url: 'knowledge_comment/edit',
                    del_url: 'knowledge_comment/del',
                    multi_url: 'knowledge_comment/multi',
                    import_url: 'knowledge_comment/import',
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'knowledge_id', title: __('Knowledge_id'), visible:false, operate: false},
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'knowledge_comment/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
